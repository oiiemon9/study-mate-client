...
const Login = () => {
  ...
  return (
    <div className="max-w-lg mx-auto  mb-24 mt-32 px-2">
      <div className=" bg-white dark:bg-base-200 border border-gray-200 dark:border-gray-700 rounded-xl shadow-2xs ">
        <Helmet>
