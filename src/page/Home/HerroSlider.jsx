...
const HerroSlider = () => {
  return (
    <>
      ...
      >
        <SwiperSlide className="bg-[url('https://i.ibb.co.com/5Ww60yJz/2149285424.jpg')] bg-cover bg-center bg-no-repeat h-full">
            ...
            <div className="max-w-[1440px] mx-auto px-6 flex flex-col h-full justify-center text-white pt-20 ">
              <div className="lg:ms-20 space-y-3 md:space-y-6">
                <motion.p
                  ...
                  className="text-xs md:text-sm uppercase tracking-wider text-green-400 font-semibold"
                >
                ...
                <motion.h1
                  ...
                  className="text-xl md:text-3xl lg:text-5xl font-extrabold drop-shadow-lg"
                >
                  Study Smarter,{' '}
                ...
                <motion.p
                  ...
                  className="max-w-2xs md:max-w-xl text-xs md:text-lg  text-gray-100/90 drop-shadow-md"
                >
        ...
        <SwiperSlide className="bg-[url('https://i.ibb.co.com/1JbXVrv8/2884.jpg')] bg-cover bg-center bg-no-repeat h-full">
          <div className="h-full bg-[linear-gradient(90deg,rgba(0,0,0,0.75)_0%,rgba(0,0,0,0)_51%)]">
            <div className="max-w-[1440px] mx-auto px-6 flex flex-col h-full justify-center text-white pt-20 ">
              <div className="lg:ms-20 space-y-3 md:space-y-6">
                ...
                <h1 className="text-xl md:text-3xl lg:text-5xl font-extrabold drop-shadow-lg">
                  Turn Study Time into{' '}
                  <span className="text-green-400">Team Time.</span>
                </h1>

                <p className="max-w-2xs md:max-w-xl text-xs md:text-lg  text-gray-100/90 drop-shadow-md">
        ...
        <SwiperSlide className="bg-[url('https://i.ibb.co.com/CKR6ZTyS/pexels-artempodrez-4492126.jpg')] bg-cover bg-center bg-no-repeat h-full">
          <div className="h-full bg-[linear-gradient(90deg,rgba(0,0,0,0.75)_0%,rgba(0,0,0,0)_51%)]">
            <div className="max-w-[1440px] mx-auto px-6 flex flex-col h-full justify-center text-white pt-20 ">
              <div className="lg:ms-20 space-y-3 md:space-y-6">
                <p className="text-xs md:text-sm uppercase tracking-wider text-green-400 font-semibold">
